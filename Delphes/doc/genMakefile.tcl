...
DELPHES_LIBS += -lFWCoreFWLite -lDataFormatsFWLite -lDataFormatsPatCandidates -lDataFormatsLuminosity -lCommonToolsUtils -lMathCore -lDataFormatsProvenance -lDataFormatsTrackReco -lTrackingToolsTransientTrack -lDataFormatsGeometrySurface -lMagneticFieldUniformEngine -lRecoVertexAdaptiveVertexFinder -lRecoVertexVertexPrimitives -lFWCoreUtilities -lRecoVertexVertexTools -lRecoVertexKalmanVertexFit -lRecoVertexLinearizationPointFinders -lRecoVertexAdaptiveVertexFit -lDataFormatsVertexReco -lRecoBTagSecondaryVertex
endif
...
executableDeps {converters/*.cpp} {examples/*.cpp} {scripts/*.cpp}
...
dist:
	...
	@mkdir -p $(DISTDIR)
	@cp -a CREDITS README VERSION Makefile configure classes converters display doc examples external modules python readers scripts $(DISTDIR)
