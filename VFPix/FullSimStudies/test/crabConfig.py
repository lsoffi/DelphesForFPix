...
config.General.requestName = 'ggh_HToZZTo4L_InputForDelphes_1202'

config.section_("JobType")
config.JobType.allowUndistributedCMSSW = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'pileup_cfg.py'
...
config.Data.inputDataset = '/GluGluToHToZZTo4L_M-125_14TeV-powheg-pythia6/TP2023SHCALDR-SHCALMar26_PU140BX25_PH2_1K_FB_V6-v1/GEN-SIM-RECO'
...
config.Data.outputDatasetTag = 'GGH_HToZZTo4L_InputForDelphes_1202'
